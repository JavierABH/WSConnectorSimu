        ...
        public string BackCheck_Serial(string _serialNumber, string _stationName)
        {
            ...
            try
            {
                ...
                else if (Pass_failBP == 1) // Si la ultima prueba que capturo el serial es Pass, lee la base de relacion de proceso
                {
                    ...
                    if (StationPP == "" && ProcessPP == "") //Si ya es la ultima estacion de la base es shipping o la que este en ProcessPath, devuelve 0|shipping o @prueba
                    {
                    ...
                    {
                        str = "1|" + ProcessPP; //Backcheck correcto
                    }
                    else //Busca si el proceso capturado existe en la base de datos de procesos
                    {
                        ...
                        {
                            str = "0|" + ProcessPP; //Backcheck incorrecto, muestra estacion correcta
                        }
                        else
                        {
                            str = "0|Fail: Estacion no encontrada"; // Backcheck incorrecto por estacion inexistente
                        }
                    }
                }
